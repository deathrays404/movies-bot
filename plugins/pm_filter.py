    ...
    if query.data.startswith("file"):
        ...
        try:
            if AUTH_CHANNEL and not await is_subscribed(client, query):
                ...
                await query.answer('click here -> https://t.me/free_files_4_U_bot',show_alert = True)
        ...
        buttons = [[
            InlineKeyboardButton('➕ If You Like Please Add Me To Your Groups ➕', url=f'http://t.me/{temp.U_NAME}?startgroup=true')
            ],[
